    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center py-12px-4sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-500 bg-clip-text text-transparent animate-fade-in mb-2">
            Personalized AI Newsletter
          </h1>
          <p className="text-lg md:text-xl font-medium bg-gradient-to-r from-teal-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-fade-in opacity-95 [animation-delay:0.15s] drop-shadow-[0_0_8px_rgba(56,189,248,0.3)]">
